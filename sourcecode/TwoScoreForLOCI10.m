function [K2Score,Gini_Score,JE_Score] = TwoScoreForLOCI10(snp_com,state)
...
%% Joint Entropy
        ...
        for i = 1:lrow
           if Pdisease(i)>0
              JointEntropyScore = JointEntropyScore + Pdisease(i).*log2(Pdisease(i));
           end
        end
         JE_Score = -JointEntropyScore;
